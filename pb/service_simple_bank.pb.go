...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc.create_user.proto\x1a\x15rpc.update_user.proto\x1a\x14rpc.login_user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xf2\x04\n" +
	"\n" +
	"SimpleBank\x12\xce\x01\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"\x90\x01\x92As\x12\x19Create a new user account\x1aVThis endpoint allows for the creation of a new user account in the Simple Bank system.\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/create_user\x12\xda\x01\n" +
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"\x9c\x01\x92A\x7f\x12\x1fUpdate an existing user account\x1a\\This endpoint allows for the updating of an existing user account in the Simple Bank system.\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_user\x12\xb5\x01\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"{\x92A_\x12\x13Authenticate a user\x1aHThis endpoint allows a user to log in and receive authentication tokens.\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_userB\x98\x01\x92Ak\x12i\n" +
	"\x0fSimple Bank API\"Q\n" +
	"\fgRPC Gateway\x12.https://github.com/grpc-ecosystem/grpc-gateway\x1a\x11none@example.com 2\x031.2Z(github.com/WatWittawat/go_simple_bank/pbb\x06proto3"
