...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc.create_user.proto\x1a\x14rpc.login_user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xba\x01\n" +
	"\n" +
	"SimpleBank\x12W\n" +
	"\n" +
	...
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_userB\x98\x01\x92Ak\x12i\n" +
	"\x0fSimple Bank API\"Q\n" +
	"\fgRPC Gateway\x12.https://github.com/grpc-ecosystem/grpc-gateway\x1a\x11none@example.com 2\x031.0Z(github.com/WatWittawat/go_simple_bank/pbb\x06proto3"
